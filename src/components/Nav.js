                ...
                <div className="z-40 flex items-center gap-6">
                    <div id="social-links">
                        <ul>
                            ...
                            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=riteshsharma34567@gmail.com" className="hover:text-gray-300 mx-1 p-1"><i className="bi bi-envelope-at-fill"></i></a>
